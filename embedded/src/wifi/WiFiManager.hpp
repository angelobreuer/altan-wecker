...
class WifiManager {
  public:
    ...
    void Start(const char *ssid, const char *passphrase) {
        ...
        ESP_ERROR_CHECK(esp_event_handler_register(WIFI_EVENT,
                                                   ...
                                                   &DoHandleDisconnect, this));
        ESP_ERROR_CHECK(esp_event_handler_register(
            IP_EVENT, IP_EVENT_STA_GOT_IP, &DoHandleStationGotIp, this));
        ...
        if (passphrase) {
            strncpy((char *)wifi_config.sta.password, passphrase,
                    strlen(passphrase));
        }
    ...
    void Stop() {
        ...
        ESP_ERROR_CHECK(esp_event_handler_unregister(
            IP_EVENT, IP_EVENT_STA_GOT_IP, &DoHandleStationGotIp));
  ...
  private:
    ...
    void HandleDisconnect(void *arg, esp_event_base_t event_base,
    ...
    static void DoHandleDisconnect(void *arg, esp_event_base_t event_base,
                                   int32_t event_id, void *event_data) {
        ((WifiManager *)arg)
            ->HandleDisconnect(arg, event_base, event_id, event_data);
    }

    void HandleStationGotIp(void *arg, esp_event_base_t event_base,
                            int32_t event_id, void *event_data) {
    ...
    static void DoHandleStationGotIp(void *arg, esp_event_base_t event_base,
                                     int32_t event_id, void *event_data) {
        ((WifiManager *)arg)
            ->HandleStationGotIp(arg, event_base, event_id, event_data);
    }
};
} // namespace wifi
} // namespace alarm_clock