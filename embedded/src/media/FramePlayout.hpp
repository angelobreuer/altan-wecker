...
namespace media {
template <size_t UnitSize, size_t TickFrequency> class FramePlayout {
  ...
  public:
    FramePlayout(
        ...
        : _abort{false}, _frameBufferReader{frameBufferReader}, _frameSink{
                                                                    frameSink} {
        auto result =
            xTaskCreate(RunTask, "Frame Playout", 2048, this, 500, nullptr);
    ...
    ~FramePlayout() { _abort = true; }

  private:
    static void RunTask(void *pvParameters) {
        auto instance =
            static_cast<FramePlayout<UnitSize, TickFrequency> *>(pvParameters);
